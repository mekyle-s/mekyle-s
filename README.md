...
### [Job-OS](https://github.com/mekyle-s/Job-OS) · AI job matching that shows its work
...
`Next.js` · `PostgreSQL + pgvector` · `embeddings` · `OpenAI` — [live demo](https://job-os-nine.vercel.app)
